          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="font-heading text-4xl lg:text-6xl font-bold text-forest mb-6 leading-tight">
                Shape the Future of <span className="text-gold">Life-Tending</span>{" "}
                Connection
              </h1>
              <p className="text-lg text-forest/80 mb-8 leading-relaxed">
                You're among the first to experience our innovative pollinator
                archetype system. As a founding member, your insights will help
                us create a meaningful wellness marketplace designed to
                transform connections.
              </p>

              {/* Germination CTA Buttons */}
              ...
              <div className="bg-sage/10 rounded-lg p-6 mb-8 border border-sage/20">
                <h3 className="font-heading text-lg font-semibold text-forest mb-2">
                  Your Germination Participation Is Invaluable
                </h3>
                <p className="text-forest/70 text-sm leading-relaxed">
                  As a founding member, your insights and feedback are essential
                  to creating an innovative wellness platform that truly serves
                  our community.
                </p>
              </div>
              ...
              <div className="flex flex-wrap items-center gap-6 text-sm text-forest/70">
                ...
                <div className="flex items-center">
                  ...
                  <span>Exclusive Germination Features</span>
                </div>
              </div>
            </div>
