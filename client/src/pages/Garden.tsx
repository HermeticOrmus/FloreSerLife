            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
              <div className="space-y-2">
                ...
                <p className="text-body text-garden-text-secondary max-w-xl">
                  A place to share your gifts freely with the community. Offer articles, meditations,
                  exercises, and wisdom to help others flourish on their journey.
                </p>
              </div>
              <Button
              ...
              {isLoading ? (
                ...
                <div className="text-center py-16">
                  ...
                  <p className="text-body text-garden-text-secondary max-w-md mx-auto mb-6">
                    Be the first to plant a seed. Share your wisdom, practices, or resources freely
                    with the community.
                  </p>
                      ...
                      <Card className="bg-garden-card border-0 rounded-card shadow-card hover:shadow-card-hover transition-all duration-300 h-full flex flex-col">
                        ...
                        <CardHeader className="pb-3">
                          <div className="flex items-start justify-between gap-3 mb-3">
                            <Badge variant="outline" className="text-xs border-garden-accent/30 shrink-0">
                        ...
                        <CardContent className="pt-0 space-y-4 flex-1 flex flex-col">
                          ...
                          <div className="flex items-center gap-2 text-xs text-garden-text-secondary">
                            {content.practitioner?.archetype && (
                              <span className="text-base">{getArchetypeIcon(content.practitioner.archetype)}</span>
                            )}
                          ...
                          {content.tags.length > 0 && (
                            <div className="flex flex-wrap gap-1.5">
                              {content.tags.slice(0, 3).map((tag, idx) => (
                                <Badge key={idx} variant="outline" className="text-xs border-garden-accent/20 px-2 py-0.5">
                                  #{tag}
                                </Badge>
                              ))}
                              {content.tags.length > 3 && (
                                <Badge variant="outline" className="text-xs border-garden-accent/20 px-2 py-0.5">
                                  +{content.tags.length - 3}
                                </Badge>
                              )}
                            </div>
                          ...
                          <div className="mt-auto pt-4 border-t border-garden-accent/10">
                            ...
                            <div className="flex gap-2">
                              ...
                              <Button
                                variant="ghost"
                                size="sm"
                                className="rounded-button hover:bg-garden-accent/10"
        ...
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            ...
            <p className="text-body-sm text-garden-text-secondary mt-2">
              Offer your wisdom freely. What you share here helps others flourish on their journey.
            </p>
          </DialogHeader>
